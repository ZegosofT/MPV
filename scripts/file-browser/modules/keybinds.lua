...
g.state.keybinds = {
    ...
    {'z',           'scroll_up_alt',    function() cursor.scroll(-1, o.wrap) end,          {repeatable = true}},
    {'s',           'scroll_down_alt',  function() cursor.scroll(1, o.wrap) end,           {repeatable = true}},
    {'q',           'up_dir_alt',       movement.up_dir},
    {'d',           'down_dir_alt',     movement.down_dir},
    {'f',           'play_alt',         function() playlist.add_files('replace', false) end},
}
